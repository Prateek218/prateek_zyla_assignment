...
const url='http://localhost:3000/getData?task=task1';
Http.open("GET", url);
...
var storedPos;
if(parseInt(jsonres.data)==0){
  storedPos = 0;
}else{
  storedPos = parseInt(jsonres.data) || null;
}
...
function sendData(position){
  ...
  xhttp.send("position="+position+"&task=task1");
}
